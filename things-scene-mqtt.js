...
Object.defineProperty(exports, 'Mqtt', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_mqtt).default;
  }
});

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"./mqtt":3}],3:[function(require,module,exports){
'use strict';
...
var Mqtt = function (_RectPath) {
  _inherits(Mqtt, _RectPath);

  function Mqtt() {
    _classCallCheck(this, Mqtt);

    return _possibleConstructorReturn(this, (Mqtt.__proto__ || Object.getPrototypeOf(Mqtt)).apply(this, arguments));
  }
  ...
  _createClass(Mqtt, [{
    ...
    key: '_initMqttConnection',
    value: function _initMqttConnection() {
      var _this2 = this;
      ...
      var _model = this.model,
          ...
          topic = _model.topic,
          _model$qos = _model.qos,
          qos = _model$qos === undefined ? 1 : _model$qos,
          _model$retain = _model.retain,
          retain = _model$retain === undefined ? false : _model$retain;
